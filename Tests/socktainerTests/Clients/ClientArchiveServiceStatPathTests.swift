...
struct ClientArchiveServiceStatPathTests {
    ...
    func matchesGetArchiveForAFile() async throws {
        ...
        let stat = try await fixture.service.statPath(container: try fixture.makeContainer(id: "web"), path: "/hello.txt")
        let (_, viaArchive) = try await fixture.service.getArchive(container: try fixture.makeContainer(id: "web"), path: "/hello.txt")
    ...
    func matchesGetArchiveForADirectory() async throws {
        ...
        let stat = try await fixture.service.statPath(container: try fixture.makeContainer(id: "web"), path: "/etc")
        let (_, viaArchive) = try await fixture.service.getArchive(container: try fixture.makeContainer(id: "web"), path: "/etc")
    ...
    func missingPath() async throws {
        ...
        do {
            _ = try await fixture.service.statPath(container: try fixture.makeContainer(id: "web"), path: "/absent")
    ...
    func missingRootfs() async throws {
        ...
        do {
            _ = try await fixture.service.statPath(container: try fixture.makeContainer(id: "ghost"), path: "/")
